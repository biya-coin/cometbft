...
https://github.com/biya-coin/cometbft/blob/main/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/biya-coin/cometbft/blob/main/spec/light-client/README.md
for the full spec
*/
package light
