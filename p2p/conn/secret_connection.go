...
import (
	...
	"github.com/biya-coin/cometbft/internal/async"
...
// https://github.com/biya-coin/cometbft/blob/main/spec/p2p/legacy-docs/peer.md#authenticated-encryption-handshake.
//
